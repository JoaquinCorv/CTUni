				...
				<div class="carousel-inner " style="height: 30rem;">
					...
					<div class="carousel-item">
						...
						<div
							class="carousel-caption d-none d-md-block opacity-50 h-25 bg-black">
							<h5>Ranking 2</h5>
							<p>UCA-Universidad Cat�lica Argentina</p>
						</div>
					</div>
					...
					<div class="carousel-item">
						...
						<div
							class="carousel-caption d-none d-md-block opacity-50 h-25 bg-black">
							<h5>Ranking 4</h5>
							<p>UTN-Universidad Tecnol�gica Nacional.</p>
						</div>
					</div>
					<div class="carousel-item">
					...
					<div class="carousel-item">
						...
						<div
							class="carousel-caption d-none d-md-block opacity-50 h-25 bg-black">
							<h5>Ranking 7</h5>
							<p>ITBA-Instituto Tecnol�gico de Buenos Aires.</p>
						</div>
					</div>
					<div class="carousel-item">
					...
					<div class="carousel-item">
						...
						<div
							class="carousel-caption d-none d-md-block opacity-50 h-25 bg-black">
							<h5>Ranking 19</h5>
							<p>UMAI-Universidad Maim�nides.</p>
						</div>
					</div>
					<div class="carousel-item">
					...
					<div class="carousel-item">
						...
						<div
							class="carousel-caption d-none d-md-block opacity-50 h-25 bg-black">
							<h5>Ranking 24</h5>
							<p>UNIPE-Universidad Pedag�gica Nacional Argentina.</p>
						</div>
					</div>
					<div class="carousel-item">
					...
					<div class="carousel-item">
						...
						<div
							class="carousel-caption d-none d-md-block opacity-50 h-25 bg-black">
							<h5>Ranking 26</h5>
							<p>ESEADE-Escuela de Econom�a y Administraci�n de Empresas.</p>
						</div>
					</div>
					<div class="carousel-item">
